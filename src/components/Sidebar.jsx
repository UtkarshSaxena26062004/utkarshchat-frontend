...
const Sidebar = ({
  ...
  return (
    // 🔥 Responsive: mobile = full width, desktop = 30%
    <div className="w-full sm:w-[30%] sm:min-w-[260px] border-r border-slate-800 flex flex-col bg-gradient-to-b from-slate-900/80 to-slate-950/80">
